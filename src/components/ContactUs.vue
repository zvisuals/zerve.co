        ...
        <div class="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div class="space-y-6">
            <form @submit="handleSubmit">
              ...
              <button 
                ...
                class="w-full mt-4 bg-[#FF6B00] hover:bg-[#FF6B00]/90 disabled:bg-[#FF6B00]/50 text-white py-3 rounded-lg transition-all duration-300 cursor-pointer hover:shadow-[0_0_15px_rgba(255,107,0,0.7)] active:scale-95"
          ...
          <div class="space-y-8">
            ...
            <div class="flex justify-center gap-6">
              <a href="https://x.com/" target="_blank" rel="noopener noreferrer" class="text-[#E5C4A8] hover:text-[#FF6B00] transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(255,107,0,0.5)] active:scale-95">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" class="text-[#E5C4A8] hover:text-[#FF6B00] transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(255,107,0,0.5)] active:scale-95">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/money-trees" target="_blank" rel="noopener noreferrer" class="text-[#E5C4A8] hover:text-[#FF6B00] transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(255,107,0,0.5)] active:scale-95">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0zM7.27 20.1H3.65V9.24h3.62V20.1zM5.47 7.76h-.03c-1.22 0-2-.83-2-1.87 0-1.06.8-1.87 2.05-1.87 1.24 0 2 .8 2.02 1.87 0 1.04-.78 1.87-2.05 1.87zM20.34 20.1h-3.63v-5.8c0-1.45-.52-2.45-1.83-2.45-1 0-1.6.67-1.87 1.32-.1.23-.11.55-.11.88v6.05H9.28s.05-9.82 0-10.84h3.63v1.54a3.6 3.6 0 0 1 3.26-1.8c2.39 0 4.18 1.56 4.18 4.89v6.21z"/>
                </svg>
              </a>
              <a href="https://www.facebook.com/MoneyTrees2019" target="_blank" rel="noopener noreferrer" class="text-[#E5C4A8] hover:text-[#FF6B00] transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(255,107,0,0.5)] active:scale-95">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M22.676 0H1.324C.593 0 0 .593 0 1.324v21.352C0 23.408.593 24 1.324 24h11.494v-9.294H9.689v-3.621h3.129V8.41c0-3.099 1.894-4.785 4.659-4.785 1.325 0 2.464.097 2.796.141v3.24h-1.921c-1.5 0-1.792.721-1.792 1.771v2.311h3.584l-.465 3.63H16.56V24h6.115c.733 0 1.325-.592 1.325-1.324V1.324C24 .593 23.408 0 22.676 0"/>
                </svg>
              </a>
              <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" class="text-[#E5C4A8] hover:text-[#FF6B00] transition-all duration-300 cursor-pointer hover:shadow-[0_0_10px_rgba(255,107,0,0.5)] active:scale-95">
                <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
