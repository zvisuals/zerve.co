    ...
    <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 md:gap-8">
      ...
      <template v-for="i in 8" :key="i">
        <div class="card-container cursor-pointer" data-aos="fade-up" :data-aos-delay="((i-1) % 4) * 100" @click="openModal(i)">
          <div :ref="`card${i}`" class="product-card group relative bg-[#223329]/50 rounded-lg md:rounded-xl overflow-hidden backdrop-blur-sm border border-[#151e18]/30 md:border-2 shadow-[0_4px_8px_rgba(0,20,0,0.5)]">
        ...
        <div class="grid grid-cols-2 gap-3 md:gap-6 md:gap-8">
          <template v-for="i in 2" :key="i+8">
            <div class="card-container cursor-pointer" data-aos="fade-up" :data-aos-delay="(i-1) * 100" @click="openModal(i+8)">
              <div :ref="`card${i+8}`" class="product-card group relative bg-[#223329]/50 rounded-lg md:rounded-xl overflow-hidden backdrop-blur-sm border border-[#151e18]/30 md:border-2 shadow-[0_4px_8px_rgba(0,20,0,0.5)]">
                <div class="aspect-[16/9] relative overflow-hidden">
